...
<body style="background-color: rgb(241, 241, 241);">
    <div class="banner_bg_main">
      ...
      <div class="container ">
         ...
         <div class="row">
           <div class="col-sm">
           <div class="tshirt_img_product"><img src="images/tshirt-img.png"></div>
           </div>
           <div class="col-sm-7 pt-5">
           <h1 class="fashion_product">Camiseta Basica</h1>
           <hr>
           <br>
           <a class="price_text">Por: 100$</a>
           <br><br>
           <a class="price_text">Cor: Amarela</a>
           <br>
           <select class="form-control" id="exampleFormControlSelect1">
            <option value="" disabled selected>Selcione um tamanho</option>
         ...
         <div class="accordion" id="accordionExample">
            ...
            <br><br>
            <a class="btn btn-success" href="Carrinho.html" role="button">Comprar</a>
            <hr>
