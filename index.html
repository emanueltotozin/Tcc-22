...
<html lang="pt-br">
   ...
   <body>
            ...
            <div class="container">
               <div class="containt_main">
                  <div id="mySidenav" class="sidenav">
                     ...
                     <a href="./PHP/produto.php">Formulario</a>
                  </div>
                     ...
                     <div class="carousel-item active">
                        <div class="row">
                           <div class="col-sm-12">
                              ...
                              <div class="buynow_bt"><a href="Produto.html">Compre Agora</a></div>
                           </div>
                        </div>
                     </div>
      ...
      <div class="fashion_section">
         <div id="main_slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <h1 class="fashion_taital">Produtos Naturais</h1>
                     <div class="fashion_section_2">
                        <div class="row">
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 <h4 class="shirt_text">Camiseta</h4>
                                 <p class="price_text">Preço  <span style="color: #262626;">R$ 30</span></p>
                                 <div class="tshirt_img"><img src="images/tshirt-img.png"></div>
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="Produto.html">Comprar Agora</a></div>
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 <h4 class="shirt_text">Camiseta Basica</h4>
                                 <p class="price_text">Preço  <span style="color: #262626;">R$ 30</span></p>
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 <h4 class="shirt_text">Vestido</h4>
                                 <p class="price_text">Preço  <span style="color: #262626;">R$ 30</span></p>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            <div class="banner_taital font-italic"><a>NATKOS</a></div>
            <div class="input_bt">
            ...
            <div class="location_main">Numero de Ajuda <a href="#">80028922</a></div>
         </div>
      </div>
      <div class="copyright_section">
         <div class="container">
            <p class="copyright_text">© 2020 All Rights Reserved. Design by Emanuel, Lucas, Ana Clara</p>
         </div>
      </div>
